...
from routes.student_tests import student_tests_bp
...
app.register_blueprint(student_tests_bp, url_prefix='/api/tests')
app.register_blueprint(admin_tests_bp, url_prefix='/admin/tests')
